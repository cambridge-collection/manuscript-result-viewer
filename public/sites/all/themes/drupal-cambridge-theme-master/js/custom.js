;(function ($) {
  ...
  projectlight.init = function () {
    ...
    projectlight.$localFooterColumns =
      projectlight.$localFooter.find('.campl-column3')
    projectlight.$globalFooterColumns =
      projectlight.$globalFooter.find('.campl-column3')
    ...
    projectlight.$globalHdrCtrl.prepend(
      '<a href="" class="campl-open-menu ir" id="open-menu">View menu</a>',
    )
    projectlight.$siteSearchBtn.prepend(
      '<a href="#" class="campl-icon-search-btn ir" id="open-search">Search</a>',
    )
    projectlight.$quicklinks.prepend(
      '<a href="#" class="campl-open-quicklinks clearfix"><span class="campl-quicklinks-txt">Quick links</span><span class="campl-icon-dropdown ir"></span></a>',
    )
    projectlight.$globalNavOuter.append(
      '<a href="#" class="campl-close-menu" >Close</a>',
    )
    ...
    $('.campl-quicklinks-list')
      .clone()
      .appendTo(projectlight.$quicklinks)
      .addClass('column12 clearfix')
    ...
    $('html').bind('click', function (e) {
      if (
        !$(e.target).hasClass('campl-open-quicklinks') &&
        !$(e.target).hasClass('campl-icon-dropdown') &&
        !$(e.target).hasClass('campl-quicklinks-txt')
      ) {
        projectlight.$quicklinks.removeClass('campl-quicklinks-open')
      }
    })
    ...
    $('.campl-global-navigation a')
      ...
      .bind('click', function (e) {
        ...
        if ($drawer.hasClass('campl-drawer-open')) {
          ...
          projectlight.$globalNavOuter
            .not($drawer)
            .removeClass('campl-drawer-open')
          //deselect any previously clicked links
          projectlight.$globalNavLI
            .not(linkClicked.parent())
            .removeClass('campl-selected')
  ...
  projectlight.setGlobalNavigationColumnHeight = function () {
    ...
    $('.campl-global-navigation-outer').each(function () {
      ...
      var maxColumnHeight = Math.max(
        $childrenOfList.eq(0).height(),
        $childrenOfList.eq(1).height(),
        $childrenOfList.eq(2).height(),
      )
  ...
  projectlight.setNavigationColumnHeight = function () {
    ...
    var maxColumnHeight = Math.max(
      $('.campl-global-navigation li a').eq(0).height(),
      $('.campl-global-navigation li a').eq(1).height(),
      $('.campl-global-navigation li a').eq(2).height(),
    )
  ...
  projectlight.setContentColumnHeight = function () {
    ...
    if (
      $('.campl-secondary-content').hasClass('campl-recessed-secondary-content')
    ) {
      secondaryContentRecessedHeight =
        ($('.campl-secondary-content').parent().width() / 100) * 36.6
    }

    var maxColumnHeight = Math.max(
      $('.campl-secondary-content').height() - secondaryContentRecessedHeight,
    ...
    if ($('.campl-tertiary-navigation').length > 0) {
      $(
        '.campl-tertiary-navigation, .campl-secondary-content, .campl-main-content',
      ).css({ 'min-height': maxColumnHeight + 50 })
      //uneven height distribution on nav and sec columns
    } else {
      $(
        '.campl-tertiary-navigation, .campl-secondary-content, .campl-main-content',
      ).css({ 'min-height': maxColumnHeight })
  ...
  projectlight.setFooterColumnsHeight = function () {
    var highestglobalFooter = Math.max(
      projectlight.$globalFooterColumns.eq(0).height(),
      projectlight.$globalFooterColumns.eq(1).height(),
      projectlight.$globalFooterColumns.eq(2).height(),
      projectlight.$globalFooterColumns.eq(3).height(),
    )
    var highestLocalFooter = Math.max(
      projectlight.$localFooterColumns.eq(0).height(),
      projectlight.$localFooterColumns.eq(1).height(),
      projectlight.$localFooterColumns.eq(2).height(),
      projectlight.$localFooterColumns.eq(3).height(),
    )
  ...
  projectlight.initTables = function () {
    ...
    $tableContainer.each(function (i) {
      ...
      var openTable =
        "<div class='campl-open-responsive-table'><a href='#' class='campl-open-responsive-table-link'>Click to open table " +
      ...
      $(this)
        .find('.campl-open-responsive-table')
        .append("<a href='#' class='campl-collapse-table'>Collapse table</a>")

      $('.campl-collapse-table').hide()

      //collapse table and restore open link to user
      $(this)
        .find('.campl-collapse-table')
        .bind('click', function (e) {
      ...
      $(this)
        .find('.campl-open-responsive-table-link')
        .bind('click', function (e) {
      ...
      $verticalTableRows.each(function (i) {
        ...
        $tableCells.each(function (i) {
          if (headerTextArray[i]) {
            $(this).prepend(
              "<span class='campl-table-heading'>" +
                headerTextArray[i] +
                '</span>',
            )
          }
  ...
  projectlight.localNav = (function () {
    ...
    return {
      init: function (u) {
        ...
        if ($navigation.length > 0) {
          ...
          if (Modernizr.mq('only all')) {
            $navigation.prepend(
              '<p class="campl-closed campl-menu-btn" id="menu-btn"><a href="#"><span>Menu</span> <span class="campl-menu-btn-arrow"></span></a></p>',
            )
            $openMenu = $('#menu-btn a')
    ...
    function setupNavigation() {
      ;($navContainer = $navigation.children(
      ...
      $navigation.find('.campl-sub').each(function () {
        ...
        if ($(this).hasClass('campl-top')) {
          $childUl.prepend(
            '<li class="campl-back-link"><a href="#"><span class="campl-back-btn campl-menu-indicator"></span>Back to section home</a></li>',
          )
        } else {
          $childUl.prepend(
            '<li class="campl-back-link"><a href="#"><span class="campl-back-btn campl-menu-indicator"></span>' +
              $(this).parent().children('.campl-title').children('a').html() +
              '</a></li>',
          )
        }
      })
      ...
      $links.click(function (e) {
        ...
        if (
          $listItemClicked.hasClass('campl-title') &&
          ...
          if ($listItemClicked.hasClass('campl-sub')) {
            ...
            if (projectlight.mobileLayout) {
              ...
              if (
                $listItemClicked.hasClass('campl-top') &&
                $linkClicked.hasClass('campl-clicked')
              ) {
    ...
    function slideMenu(directionToSlide) {
      ...
      if (directionToSlide === 'forward') {
        ...
        $navContainer
          .stop()
          .animate({ left: currentLeftPos - widthOfMenu }, 300, function () {})
      } else {
  ...
  projectlight.createCarousel = function () {
    ...
    carousel.init = function () {
      ...
      if (this.maxSlides > 1) {
        this.slides.css({
          width:
            this.carouselWidth * (this.maxSlides + 2) +
            this.carouselWidth +
            'px',
          left: '-' + this.carouselWidth * this.currentSlide + 'px',
        })
      }
      ...
      for (var cc = 0; cc < this.maxSlides; cc++) {
        this.lookupPos.push(
          -cc * parseInt(this.carouselContainer.innerWidth(), 10),
        )
      }
      ...
      if (this.maxSlides > 1) {
        ...
        var clonedLastSlide = this.slides
          .children('li:nth-child(' + this.maxSlides + ')')
          .clone()
    ...
    carousel.createPaginationIndicator = function () {
      carousel.slides.children().each(function (i) {
        var slideNo = i + 1
        $(this)
          .find('.campl-slide-caption')
          .append(
            "<span class='campl-carousel-pagination'>" +
              slideNo +
              ' of ' +
              carousel.maxSlides +
              '</span>',
    ...
    carousel.createCarouselControls = function () {
      ...
      carouselControls.className =
        'campl-unstyled-list clearfix campl-carousel-controls'
      ...
      if (this.slides.filter(':animated').length === 0) {
        ...
        this.slides.animate({ left: endPos }, 2500, function () {
          ...
          if (carousel.currentSlide === carousel.maxSlides) {
            carousel.slides.css({
              left:
                -carousel.maxSlides * carousel.carouselContainer.innerWidth() +
                'px',
            })
    ...
    projectlight.resetCarousel = function () {
      ...
      if (carousel.maxSlides > 1) {
        carousel.slides.css({
          width:
            carousel.carouselWidth * (carousel.maxSlides + 2) +
            carousel.carouselWidth +
            'px',
          left: '-' + carousel.carouselWidth * carousel.currentSlide + 'px',
        })
      }
      ...
      for (var cc = 0; cc < carousel.maxSlides; cc++) {
        carousel.lookupPos.push(
          -cc * parseInt(carousel.carouselContainer.innerWidth(), 10),
        )
      }
  ...
  projectlight.markExternalLinks = function () {
    if (jQuery.browser.msie) {
      $("#content a[href*='cam.ac.uk']")
        .not(".campl-carousel a[href*='http://']")
  ...
  $(function () {
    ...
    $('.campl-vertical-breadcrumb-children .campl-selected a').bind(
      'click',
      function (e) {
        e.preventDefault()
      },
    ...
    $('.campl-notifications-panel').each(function () {
      var $thisElem = $(this)
      $thisElem.append(
        "<a href='#' class='ir campl-close-panel'>Close panel</a>",
      )
        ...
        if (
          ...
          projectlight.$slideCaption.each(function (i) {
            if ($.trim(projectlight.slideCaptionItems[i]).length > 51) {
              $(this).text(
                $.trim(projectlight.slideCaptionItems[i])
                  .substring(0, 50)
                  .split(' ')
                  .slice(0, -1)
                  .join(' ') + '...',
          ...
          projectlight.$carouselContent.each(function (i) {
            if ($.trim(projectlight.slideCaptionItems[i]).length > 36) {
              $(this).text(
                $.trim(projectlight.carouselContentItems[i])
                  .substring(0, 35)
                  .split(' ')
                  .slice(0, -1)
                  .join(' ') + '...',
