  ...
  d.widget('ui.autocomplete', {
    ...
    _create: function () {
      ...
      this.menu = d('<ul></ul>')
        ...
        .appendTo(d(this.options.appendTo || 'body', b)[0])
        ...
        .menu({
          focus: function (c, e) {
            ...
            false !== a._trigger('focus', c, { item: e }) &&
              /^key/.test(c.originalEvent.type) &&
              a.element.val(e.value)
          },
          selected: function (c, e) {
            ...
            false !== a._trigger('select', c, { item: g }) &&
    ...
    _setOption: function (a, b) {
      ...
      if (a === 'appendTo')
        this.menu.element.appendTo(
          d(b || 'body', this.element[0].ownerDocument)[0],
        )
    },
    ...
    _resizeMenu: function () {
      ...
      a.outerWidth(
        Math.max(a.width('').outerWidth(), this.element.outerWidth()),
      )
    },
